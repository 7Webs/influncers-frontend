...
const Categories = () => {
        ...
        useInfiniteQuery({
            ...
            queryFn: async ({ pageParam = 0 }) => {
                const response = await apiService.get(
                    `deals/top-deals?take=8&skip=${pageParam}&category=${categoryId}`
                );
    ...
    return (
        <div className="trendyProducts">
            ...
            <div ref={loadMoreRef} className="loading-trigger" style={{ display: 'flex', justifyContent: 'center', padding: '20px' }}>
                {(isFetchingNextPage || (isFetching && !isFetchingNextPage)) && <CircularProgress />}
