                ...
                <Box sx={styles.formContainer}>
                    ...
                    <Box sx={{ p: 2, bgcolor: "#f8f9fa", borderRadius: 1, mb: 3 }}>
                        ...
                        <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                            Please attach screenshots of your social media posts to verify the promotion
                        </Typography>
                        ...
                        <label htmlFor="image-upload">
                            <Button
                                ...
                                component="span"
                                fullWidth
                                startIcon={formData.image.length > 0 ? <CheckCircleOutline color="success" /> : null}
                                sx={{
                            ...
                            >
                                {formData.image.length > 0
                                    ? `${formData.image.length} Image${formData.image.length !== 1 ? "s" : ""} Selected`
                                    : "Choose Images"}
                            </Button>
                        </label>
                    </Box>
                    ...
                    {previewUrls.length > 0 && (
                        <Box sx={{ p: 2, border: "1px solid #e0e0e0", borderRadius: 1, bgcolor: "#fff" }}>
